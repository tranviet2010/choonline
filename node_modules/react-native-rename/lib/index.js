...
loadAppConfig().then(function (appConfig) {
  ...
  _commander2.default.version(projectVersion).arguments('<newName>').option('-b, --bundleID [value]', 'Set custom bundle identifier eg. "com.junedomingo.travelapp"').action(function (newName) {
      ...
      listOfFoldersAndFiles.forEach(function (element, index) {
        ...
        setTimeout(function () {
          ...
          if (_fs2.default.existsSync(_path2.default.join(__dirname, element)) || !_fs2.default.existsSync(_path2.default.join(__dirname, element))) {
            var move = _shelljs2.default.exec('git mv -k "' + _path2.default.join(__dirname, element) + '" "' + _path2.default.join(__dirname, dest) + '"');
      ...
      return new Promise(function (resolve) {
        readFile(_path2.default.join(__dirname, 'android/app/src/main/AndroidManifest.xml')).then(function (data) {
          ...
          if (!_fs2.default.existsSync(fullNewBundlePath)) {
            ...
            var move = _shelljs2.default.exec('git mv -k "' + fullCurrentBundlePath + '/"* "' + fullNewBundlePath + '"');
