    ...
    >
      <HomeStack.Screen
        ...
        options={({ route }) => ({
          ...
          headerTitle: () => {
            return (
              <View style={{ justifyContent: 'center', alignItems: 'center' }}>
                <Text style={{ color: 'white', fontSize: sizeFont(5), marginRight: sizeWidth(15), fontWeight: 'bold' }}>Chợ An Bình City</Text>
              </View>
            )
          },
          headerLeft: () => (
          ...
          headerRight: () => {
            return (
              <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', width: 120, paddingRight: 10 }}>
                <TouchableOpacity
